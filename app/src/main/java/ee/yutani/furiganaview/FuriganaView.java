...
// Package
package ee.yutani.furiganaview;
...
public class FuriganaView extends View {
    private class TextFurigana {
        ...
        public void draw(Canvas canvas, float x, float y) {
            ...
            //to bound canvas when long furigana for short kanji
            if (x < 0)
                x = 0;
            ...
            //Draw furigana text
            // m_paint_f.setColor(getResources().getColor(R.color.red));
    ...
    private class TextNormal {
        ...
        public float draw(Canvas canvas, float x, float y) {
            if (m_is_marked) {
                ...
                // m_paint_k_norm.setColor(Color.BLUE);
    ...
    // Paints
    private TextPaint m_paint_f = new TextPaint(); //Furigana
