...
public class MMBindFontUtils {
    ...
    public static AppSharePreference appPreference;

    private static boolean isSupportUnicode;

    //From Myat Min Soe's Repo
    public static void checkMyanmarUnicodeSupport(Context context) {

        appPreference = new AppSharePreference(context);

        if (android.os.Build.VERSION.SDK_INT <= Build.VERSION_CODES.KITKAT) {
            Paint paint = new Paint();
            isSupportUnicode = paint.measureText("\u1000\u1039\u1000") < paint.measureText("\u1000") + paint.measureText("\u1000") / 3;
        } else {
            ...
            textView1.setTypeface(FontCache.get(Fonts.MM3, context));
            textView2.setTypeface(FontCache.get(Fonts.MM3, context));
            textView3.setTypeface(FontCache.get(Fonts.MM3, context));
            textView4.setTypeface(FontCache.get(Fonts.MM3, context));
            ...
            isSupportUnicode = fontTypeOne == fontTypeTwo && fontTypeThree == fontTypeFour;
        }

        appPreference.setUnicodeSupportFlag(isSupportUnicode);
    }

    public static String mmTextUnicodeOrigin(String originalText) {
       /* if (checkMyanmarUnicodeSupport()) {
            return originalText;
        } else {*/
